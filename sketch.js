...
z = 1;
  ...
  if(points <-100){
    alert("You lose You Identity");
    window.location.replace("https://anshugahlyan.github.io/opss2/index.html");
    points = 0;
    box.x = 675;
    box.y= 320;
    player.x = 675;
...
if(points < -80){
  ...
  if(points === -80){
    alert("You are near to lose Your Identity");
   points = points-5;
  ...
  if(intro.x === 670){
    ...
    stroke("black");
    strokeWeight(2);
    text("It is The Second Step Toward Verification",500,40);
    strokeWeight(0);
    fill("black");
    textSize(30);
    text("It is a Dangrous Game If you Lose They Will Get to Know Your Identity",450,100);
    ...
    text("If the points will be in -100 then You will lose the Fake Identity",380,225);
    textSize(40);
    fill("Yellow");
    text("Rules",80,285);
    textSize(25);
    ...
    textSize(20);
    fill("white");
    text("Press M to continue",1200,500);
  }else{
    a.x = 2000;
    b.x = 2000;
    c.x = 2000;
